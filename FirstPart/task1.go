...
func main() {
	...
	if len(os.Args) == 1 { //если длина переданных аргументов ровна "1" это означает что нам ничего не передали так
		// как первое значение это спец значение оно идет по умолчанию
